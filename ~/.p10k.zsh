# Generated by Powerlevel10k configuration wizard on 2025-09-27 at 22:06 CEST.
...
# disconnected, compact, concise, transient_prompt, instant_prompt=verbose.
...
# Show home in cursor {{{1
prompt_subst=true
PROMPT='${PWD/#$HOME/\/home\/$USER}%# '
